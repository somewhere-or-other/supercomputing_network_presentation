...
% TO PREP SLIDES, COMMENT THE ABOVE LINE, AND UNCOMMENT THE FOLLOWING THREE
...
\section{Types of Communication}
  \frame{
    ...
    \begin{itemize}
      ...
      \begin{itemize}
	\pause\item There's a lot of research in speeding up \emph{intra}-node communication, but that's more of a Computer Science or Electrical Engineering problem.  We'll sepend our time today on \emph{inter}-node communication
      \end{itemize}
    \end{itemize}
...
\section{Topologies}
    \frame{
      ...
      Infinband puts very little restriction on the physical topology of the network.  
      \begin{itemize}
...
%     %
  ...
  \frame{
    ...
    \begin{itemize}
      \item<1->Pro: Excellent for large topologies (no spine switches to buy)
  ...
  \frame{
    \frametitle{Hypercube\footnote{Note that this is really just a special case of a Torus.} example (4-dimensional)}
    \begin{itemize}
...
\Edge[style=bend left](F)(X)
  ...
  \frame{
    \frametitle{MBB Example - Torus (cont)}
...
\Edge[style=bend left](F)(X)
  ...
  \frame{
    ...
    \begin{itemize}
      ...
      \begin{itemize}
	\pause\item Assuming each node is a switch, with 16 hosts hanging off it, what is the MBB:ClientBW ratio for the Green (MBB) line?
	\begin{itemize}
  ...
  \frame{
    ...
    \begin{itemize}
      ...
      \item 4 links coming out of each of the 24 switches on the bottom (1 to each of 4 core sw)
    \end{itemize}
	...
	\Vertex[x=0,y=0,style=node]{S1}
	\Vertex[x=1,y=0,style=node]{S2}
	\Vertex[x=2,y=0,style=node]{S3}
	\Vertex[x=3,y=0,style=node]{S4}
	\Vertex[x=4,y=0,style=node]{S5}
	\Vertex[x=5,y=0,style=node]{S6}
	\Vertex[x=6,y=0,style=node]{S7}
	\Vertex[x=7,y=0,style=node]{S8}
	\Vertex[x=8,y=0,style=node]{S9}
	\Vertex[x=9,y=0,style=node]{S10}
	\Vertex[x=10,y=0,style=node]{S11}
	\Vertex[x=11,y=0,style=node]{S12}
	\Vertex[x=12,y=0,style=node]{S13}
	\Vertex[x=13,y=0,style=node]{S14}
	\Vertex[x=14,y=0,style=node]{S15}
	\Vertex[x=15,y=0,style=node]{S16}
	\Vertex[x=16,y=0,style=node]{S17}
	\Vertex[x=17,y=0,style=node]{S18}
	\Vertex[x=18,y=0,style=node]{S19}
	\Vertex[x=19,y=0,style=node]{S20}
	\Vertex[x=20,y=0,style=node]{S21}
	\Vertex[x=21,y=0,style=node]{S22}
	\Vertex[x=22,y=0,style=node]{S23}
	\Vertex[x=23,y=0,style=node]{S24}

	\Vertex[x=0,y=10,style=node]{C1}
	\Vertex[x=7.66,y=10,style=node]{C2}
	\Vertex[x=15.33,y=10,style=node]{C3}
	\Vertex[x=23,y=10,style=node]{C4}
...
\section{Multi-path Ethernet and TCP/IP}
  \frame{
	...
	\item<3-> TRILL - Transparent Interconnection of Lots of Links - Multi-path Ethernet\footnote<3->{The best reference I'm aware of is \emph{Introduction to Trill} by Radia Perlman and Donald Eastlake, available at \url{http://www.ipjforum.org/?p=582}}
      \end{itemize}
    \end{itemize}
...
\section{Conclusions}
  \frame{
    ...
    \begin{itemize}
      ...
      \item<4-> You absolutely \emph{must} understand the communication patterns of your applicaiton, in order to select the correct technology and topology
      \item<5-> What you're used to doing now, may change in the future (eg. TRILL)
    \end{itemize}
