...
%   }
  ...
  \frame{
    \frametitle{What are some important characteristics for evaluating topologies?}
    \begin{itemize}
...
\Edge[style=bend left](F)(X)
  ...
  \frame{
    ...
    \begin{itemize}
      ...
      \pause\item For example, using the diagram on the previous slide:
      \begin{itemize}
...
\section{Conclusions}
  \frame{
    ...
    \begin{itemize}
      ...
      \item<4-> What you're used to doing now, may change in the future (eg. TRILL)
    \end{itemize}
