...
\section{Types of HPC}
  ...
  \frame{
	...
	\pause\item Provide necessary coordination among resources
      ...
      \pause\item In general, for HPC problems, communication is key.
      \begin{itemize}
	\pause\item For inter-process communication
	\pause\item For communicating with storage
      \end{itemize}
    \end{itemize}
...
% 
  ...
  \frame{
    ...
    \begin{center}
	\begin{tikzpicture}[>=latex,line join=bevel,scale=0.32]
